...
use axguowen\helper\contract\Arrayable;
use axguowen\helper\contract\Jsonable;
use axguowen\helper\Arr;

/**
 * 数据集管理基础类
 */
if (class_exists('think\Collection')) {
    class BaseCollection extends \think\Collection
    {}
} else {
    class BaseCollection implements ArrayAccess, Countable, IteratorAggregate, JsonSerializable, Arrayable, Jsonable
    {
        /**
         * 数据集数据
         * @var array
